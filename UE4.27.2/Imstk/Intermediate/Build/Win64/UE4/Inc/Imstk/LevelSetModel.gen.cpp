...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULevelSetModel_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULevelSetModel_Statics::NewProp_MeshComp_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/LevelSetModel.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULevelSetModel_Statics::NewProp_MeshComp = { "MeshComp", nullptr, (EPropertyFlags)0x0020080000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelSetModel, MeshComp), Z_Construct_UClass_UProceduralMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULevelSetModel_Statics::NewProp_MeshComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSetModel_Statics::NewProp_MeshComp_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULevelSetModel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULevelSetModel_Statics::NewProp_MeshComp,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULevelSetModel_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_ULevelSetModel()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ULevelSetModel_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ULevelSetModel, 2564239022);
	template<> IMSTK_API UClass* StaticClass<ULevelSetModel>()
	{
		return ULevelSetModel::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ULevelSetModel(Z_Construct_UClass_ULevelSetModel, &ULevelSetModel::StaticClass, TEXT("/Script/Imstk"), TEXT("ULevelSetModel"), false, nullptr, nullptr, nullptr);
