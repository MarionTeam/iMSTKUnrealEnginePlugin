...
public:
	...
	// Zeros the tangents for the spline in Unreal 
	...
	// Experimental setting to generate visuals for the thread
	// UPROPERTY(EditAnywhere, Category = "iMSTK|Constraints")
		bool bGenerateMesh = false;

	UPROPERTY(EditAnywhere, meta = (EditCondition = "bGenerateMesh", EditConditionHides), Category = "iMSTK|Constraints")
		int NumSides = 8;
