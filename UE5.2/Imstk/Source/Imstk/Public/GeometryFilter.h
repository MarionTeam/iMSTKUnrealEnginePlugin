...
struct FSphereGeomStruct : public FGeometryTypeStruct
{
	...
	// Radius of the sphere. Note: default sphere in Unreal is 50
...
struct FSurfaceMeshGeomStruct : public FGeometryTypeStruct
{
	...
	// Flips the normals of the surface mesh
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "iMSTK")
		bool bFlipNormals;
...
struct FCapsuleGeomStruct : public FGeometryTypeStruct
{
	...
	// Radius of the capsule. Note: default capsule has 12.5 radius
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (ClampMin = "0.01"), Category = "iMSTK")
		double Radius = 12.5;
	// Length of the capsule. Note: default capsule has 50 length
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (ClampMin = "0.01"), Category = "iMSTK")
		double Length = 50;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "iMSTK")
		FVector GeometryOffset;
...
struct FCylinderGeomStruct : public FGeometryTypeStruct
{
	...
	// Radius of the capsule. Note: default cylinder has 12.5 radius
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (ClampMin = "0.01"), Category = "iMSTK")
		double Radius = 12.5;
	// Length of the capsule. Note: default cylinder has 50 length
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (ClampMin = "0.01"), Category = "iMSTK")
		double Length = 50;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "iMSTK")
		FVector GeometryOffset;
...
struct FGeometryFilter
{
	...
	// The type of geometry for the model
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "iMSTK")
