...
public:
	...
	*/
	...
	// Dimensions of the assigned static mesh if not using an image data file
	...
	// Bounding actor for the static mesh. Destroys the actor on init
	UPROPERTY(EditAnywhere, meta = (EditCondition = "ImageData == nullptr", EditConditionHides), Category = "iMSTK")
		AActor* BoundingActor;
	
	// Number of chunks the model is divided into
