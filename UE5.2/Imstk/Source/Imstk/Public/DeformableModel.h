...
public:
	...
	// Divide the mass by the number of vertices in the model
	UPROPERTY(EditAnywhere, Category = "iMSTK")
		bool bScaleMassPerVertex = false;

	// Damping coefficient applied to linear velocity
	UPROPERTY(EditAnywhere, Category = "iMSTK|PbdModel")
		double LinearDampingCoefficient = 0.01;

	// Damping coefficient applied to angular velocity
	UPROPERTY(EditAnywhere, Category = "iMSTK|PbdModel")
