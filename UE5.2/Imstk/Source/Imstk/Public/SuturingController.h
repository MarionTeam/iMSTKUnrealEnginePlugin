...
public:
	...
	// Multiplier of the inertia tensor
	...
	*/
	...
	// Ignore angular forces and calculations and use spring and damper forces instead
	...
	// Scaling of the force on the device
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "bForceTool || bHapticTool", EditConditionHides), Category = "iMSTK|Force")
		double ForceScaling = 1;

	/* For haptic tools
	UPROPERTY(EditAnywhere, Meta = (ClampMin = "0"), meta = ( EditCondition = "bHapticTool", EditConditionHides), Category = "iMSTK|Force")
	...
	*/
	...
	// Kernel size
	UPROPERTY(EditAnywhere, Meta = (ClampMin = "0"), meta = (EditCondition = "bUseForceSmoothening", EditConditionHides), Category = "iMSTK|Force")
