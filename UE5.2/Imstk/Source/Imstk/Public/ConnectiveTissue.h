...
public:
	...
	// Whether or not the tissue is tearable. Note: Do partitioning must be set to false in the shared PBDModel in the iMSTK manager
	UPROPERTY(EditAnywhere, Category = "iMSTK|ConnectiveTissue")
	...
	// Whether or not the tissue is burnable. Note: Do partitioning must be set to false in the shared PBDModel in the iMSTK manager
	UPROPERTY(EditAnywhere, Category = "iMSTK|ConnectiveTissue")
...
private:
	...
	std::shared_ptr<imstk::PbdObjectCellRemoval> CellRemover;
