...
public:
    ...
    ///@{
    void setEnableBoundaryCollisions(const double enableBoundaryCollisions) { if (enableBoundaryCollisions) m_enableBoundaryCollisions = true; else m_enableBoundaryCollisions = false; }
