...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_Imstk_ECollisionInteractionType_Statics::Enumerators[] = {
		...
		{ "SphereToCylinderCD", (int64)SphereToCylinderCD },
		{ "PointSetToSphereCD", (int64)PointSetToSphereCD },
		{ "PointSetToCapsuleCD", (int64)PointSetToCapsuleCD },
		{ "PointSetToCylinderCD", (int64)PointSetToCylinderCD },
		...
		{ "LineMeshToLineMeshCCD", (int64)LineMeshToLineMeshCCD },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Imstk_ECollisionInteractionType_Statics::Enum_MetaDataParams[] = {
		...
		{ "Comment", "// Defines the different types of collisions. Values must have the same name as the collision type in imstk\n" },
		{ "LineMeshToLineMeshCCD.Name", "LineMeshToLineMeshCCD" },
		...
		{ "PointSetToCylinderCD.Name", "PointSetToCylinderCD" },
		...
		{ "SphereToCylinderCD.Name", "SphereToCylinderCD" },
		...
		{ "ToolTip", "Defines the different types of collisions. Values must have the same name as the collision type in imstk" },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCollisionInteraction_Init_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Initializes the interaction within iMSTK between the set models set on the CollisionInteraction\n\x09* @return None\n\x09*/" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "Initializes the interaction within iMSTK between the set models set on the CollisionInteraction\n@return None" },
	};
#endif
...
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_CollisionIterations;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCollisionInteraction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCollisionInteraction_Init, "Init" }, // 1276168530
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_Model1_MetaData[] = {
		...
		{ "Comment", "// The first model in the interaction that the collision will be made between. Can be set in blueprint. \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "The first model in the interaction that the collision will be made between. Can be set in blueprint." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_Model2_MetaData[] = {
		{ "Category", "Collision Interaction" },
		{ "Comment", "// The second model in the interaction that the collision will be made between. Can be set in blueprint. \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "The second model in the interaction that the collision will be made between. Can be set in blueprint." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_Friction_MetaData[] = {
		{ "Category", "Collision Interaction" },
		{ "Comment", "// Friction of the interaction\n" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "Friction of the interaction" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_Stiffness_MetaData[] = {
		{ "Category", "Collision Interaction" },
		{ "Comment", "// Stiffness of the interaction\n" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "Stiffness of the interaction" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_Restitution_MetaData[] = {
		{ "Category", "Collision Interaction" },
		{ "Comment", "// Restitution of the interaction\n" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
		{ "ToolTip", "Restitution of the interaction" },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_CollisionIterations_MetaData[] = {
		{ "Category", "Collision Interaction" },
		{ "ModuleRelativePath", "Public/CollisionInteraction.h" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_CollisionIterations = { "CollisionIterations", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCollisionInteraction, CollisionIterations), METADATA_PARAMS(Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_CollisionIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_CollisionIterations_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCollisionInteraction_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCollisionInteraction_Statics::NewProp_CollisionIterations,
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_CollisionInteraction_h_Statics::EnumInfo[] = {
		{ ECollisionInteractionType_StaticEnum, TEXT("ECollisionInteractionType"), &Z_Registration_Info_UEnum_ECollisionInteractionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 134036780U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_CollisionInteraction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCollisionInteraction, UCollisionInteraction::StaticClass, TEXT("UCollisionInteraction"), &Z_Registration_Info_UClass_UCollisionInteraction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCollisionInteraction), 3495888230U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_CollisionInteraction_h_3000055978(TEXT("/Script/Imstk"),
