...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UImstkBehaviour_IsInitialized_Statics::Function_MetaDataParams[] = {
		{ "Category", "Imstk" },
		{ "Comment", "/** Check if behaviour is initialized in iMSTK. Can be called in blueprint to avoid null references\n\x09* @return True if behaviour is initialized in iMSTK\n\x09*/" },
		{ "ModuleRelativePath", "Public/ImstkBehaviour.h" },
		{ "ToolTip", "Check if behaviour is initialized in iMSTK. Can be called in blueprint to avoid null references\n@return True if behaviour is initialized in iMSTK" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UImstkBehaviour_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UImstkBehaviour_IsInitialized, "IsInitialized" }, // 966390281
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_ImstkBehaviour_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImstkBehaviour, UImstkBehaviour::StaticClass, TEXT("UImstkBehaviour"), &Z_Registration_Info_UClass_UImstkBehaviour, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImstkBehaviour), 52333403U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_ImstkBehaviour_h_1867128351(TEXT("/Script/Imstk"),
