...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_EnumVal_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_EnumVal;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewProp_EnumVal_MetaData[] = {
		{ "Comment", "// Hidden value that corresponds to the enum value\n" },
		{ "ModuleRelativePath", "Public/GeometryFilter.h" },
		{ "ToolTip", "Hidden value that corresponds to the enum value" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewProp_EnumVal = { "EnumVal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryTypeStruct, EnumVal), METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewProp_EnumVal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewProp_EnumVal_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewProp_EnumVal,
	};
...
template<> IMSTK_API UScriptStruct* StaticStruct<FSurfaceMeshGeomStruct>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSurfaceMeshGeomStruct_Statics::NewProp_bFlipNormals = { "bFlipNormals", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSurfaceMeshGeomStruct), &Z_Construct_UScriptStruct_FSurfaceMeshGeomStruct_Statics::NewProp_bFlipNormals_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSurfaceMeshGeomStruct_Statics::NewProp_bFlipNormals_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSurfaceMeshGeomStruct_Statics::NewProp_bFlipNormals_MetaData)) };
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCapsuleGeomStruct, Radius), METADATA_PARAMS(Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Length = { "Length", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCapsuleGeomStruct, Length), METADATA_PARAMS(Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Length_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewProp_Length_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPlaneGeomStruct_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlaneGeomStruct, Normal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlaneGeomStruct_Statics::NewProp_Normal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlaneGeomStruct_Statics::NewProp_Normal_MetaData)) };
...
template<> IMSTK_API UScriptStruct* StaticStruct<FGeometryFilter>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_GeomType = { "GeomType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryFilter, GeomType), Z_Construct_UEnum_Imstk_EGeometryType, METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_GeomType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_GeomType_MetaData)) }; // 2303666173
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_CylinderStruct = { "CylinderStruct", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryFilter, CylinderStruct), Z_Construct_UScriptStruct_FCapsuleGeomStruct, METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_CylinderStruct_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_CylinderStruct_MetaData)) }; // 3040201609
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_PlaneStruct = { "PlaneStruct", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryFilter, PlaneStruct), Z_Construct_UScriptStruct_FPlaneGeomStruct, METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_PlaneStruct_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewProp_PlaneStruct_MetaData)) }; // 1336838230
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_GeometryFilter_h_Statics::EnumInfo[] = {
		{ EGeometryType_StaticEnum, TEXT("EGeometryType"), &Z_Registration_Info_UEnum_EGeometryType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2303666173U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_GeometryFilter_h_Statics::ScriptStructInfo[] = {
		{ FGeometryTypeStruct::StaticStruct, Z_Construct_UScriptStruct_FGeometryTypeStruct_Statics::NewStructOps, TEXT("GeometryTypeStruct"), &Z_Registration_Info_UScriptStruct_GeometryTypeStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGeometryTypeStruct), 3635242994U) },
		{ FSphereGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FSphereGeomStruct_Statics::NewStructOps, TEXT("SphereGeomStruct"), &Z_Registration_Info_UScriptStruct_SphereGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSphereGeomStruct), 2971133542U) },
		{ FSurfaceMeshGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FSurfaceMeshGeomStruct_Statics::NewStructOps, TEXT("SurfaceMeshGeomStruct"), &Z_Registration_Info_UScriptStruct_SurfaceMeshGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSurfaceMeshGeomStruct), 1065430623U) },
		{ FCapsuleGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FCapsuleGeomStruct_Statics::NewStructOps, TEXT("CapsuleGeomStruct"), &Z_Registration_Info_UScriptStruct_CapsuleGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCapsuleGeomStruct), 3040201609U) },
		{ FCylinderGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FCylinderGeomStruct_Statics::NewStructOps, TEXT("CylinderGeomStruct"), &Z_Registration_Info_UScriptStruct_CylinderGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCylinderGeomStruct), 2255907129U) },
		...
		{ FOrientedBoxGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FOrientedBoxGeomStruct_Statics::NewStructOps, TEXT("OrientedBoxGeomStruct"), &Z_Registration_Info_UScriptStruct_OrientedBoxGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOrientedBoxGeomStruct), 80512015U) },
		{ FPlaneGeomStruct::StaticStruct, Z_Construct_UScriptStruct_FPlaneGeomStruct_Statics::NewStructOps, TEXT("PlaneGeomStruct"), &Z_Registration_Info_UScriptStruct_PlaneGeomStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlaneGeomStruct), 1336838230U) },
		{ FGeometryFilter::StaticStruct, Z_Construct_UScriptStruct_FGeometryFilter_Statics::NewStructOps, TEXT("GeometryFilter"), &Z_Registration_Info_UScriptStruct_GeometryFilter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGeometryFilter), 60252469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Imstk_Source_Imstk_Public_GeometryFilter_h_692493024(TEXT("/Script/Imstk"),
		nullptr, 0,
