...
public:
	...
	// TODO: CURRENTLY ONLY SET UP FOR RIGID PBDS
	// If data should be imported from a file to generate colliding geometry
	//UPROPERTY(EditAnywhere, meta = (EditCondition = "bRigidBody", EditConditionHides), Category = "General")
	//	bool bCollidingGeometryFromFile = false;
	//// File path from the content directory
