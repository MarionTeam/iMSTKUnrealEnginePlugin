...
void UImstkController::InitController()
{
	...
	if ((ToolType == EToolType::GraspingTool && (ToolGeometry != EToolGeometry::SphereTool && ToolGeometry != EToolGeometry::CapsuleTool)) ||
		(ToolType == EToolType::StitchingTool && ToolGeometry != EToolGeometry::LineMeshTool) ||
		(ToolType == EToolType::CuttingTool && ToolGeometry != EToolGeometry::SurfaceMeshTool)) {
		if (GEngine)
		...
		SubsystemInstance->AllControllers.Remove(this);
	}
}
