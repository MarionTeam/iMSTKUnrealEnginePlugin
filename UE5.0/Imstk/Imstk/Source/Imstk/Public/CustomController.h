...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Imstk")
		void MoveControllerToRaycastOnPlane(FVector RayStart, FVector RayDir, FQuat Orientation, UDynamicalModel* PlaneActor, bool bUpdateUnrealPosRot = true);
protected:
	...
	* @return None
	*/
	void UpdateImstkPosRot(FVector WorldPos, FQuat Orientation, FVector WorldDir = FVector::ZeroVector, UDynamicalModel* PlaneActor = nullptr);
