...
void UImstkController::InitializeComponent()
{
	...
	if (GetWorld() && GetWorld()->GetGameInstance()) {
		...
		if (ToolGeometry == EToolGeometry::SphereTool || ToolGeometry == EToolGeometry::CapsuleTool)
			bStitchingTool = false;
		else if (ToolGeometry == EToolGeometry::LineMeshTool)
			bGraspingTool = false;
	}
...
void UImstkController::SetToolPicking(std::shared_ptr<imstk::PbdObjectGrasping> Picking)
{
